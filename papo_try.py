...
def get_model(
    ...
    metric = load_metric("sacrebleu") # TODO: REMOVE
    ...
    args = Seq2SeqTrainingArguments(
        f"{model_name}-finetuned-{source_lang}-to-{target_lang}_papo_try",
...
validation_dataset = Dataset.from_dict(path_to_dict("data/val.labeled"))
