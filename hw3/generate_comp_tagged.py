...
def main():
    train_dataset = Dataset.from_dict(load_ds_to_dict("/home/tomer/PycharmProjects/nlp_ex4/data/train.labeled"))
    ...
    with open("/home/tomer/PycharmProjects/nlp_ex4/data/ds_dependency_parsed.json", "w") as outfile:
