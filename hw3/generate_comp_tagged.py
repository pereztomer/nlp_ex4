...
def main():
    train_dataset = Dataset.from_dict(load_ds_to_dict("/home/user/PycharmProjects/nlp_ex4/data/val.labeled"))
    ...
    with open("/home/user/PycharmProjects/nlp_ex4/data/val_dependency_parsed.json", "w") as outfile:
